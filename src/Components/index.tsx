...
function Table (tabela:ITable){
  ...
  {/* 1º coluna */}
          ...
          <tr className="linha">vago </tr>
            ...
            <tr className="linha"><img src={`img/${tabela.a4}.png`} className="img"/> </tr>
  ...
  {/* 2º coluna */}
          <td>
            ...
            <tr className="linha"><img src={`img/${tabela.b4}.png`} className="img" /> </tr>
  ...
  {/* 3º coluna */}
          <td>
           <tr className="linha">vago </tr>
            ...
            <tr className="linha"><img src={`img/${tabela.c4}.png`} className="img" /> </tr>
  ...
  {/* 4º coluna */}
          <td>
            ...
            <tr className="linha"><img src={`img/${tabela.d4}.png`} className="img" /> </tr>
  ...
  {/* 5º coluna */}
          <td>
            ...
            <tr className="linha"><img src={`img/${tabela.e4}.png`} className="img" /> </tr>
  ...
  {/* 6º coluna */}
          <td>
            ...
            <tr className="linha"><img src={`img/${tabela.f4}.png`} className="img" /> </tr>
  ...
  {/* 1º coluna */}
          <td>
            ...
            <tr className="linha"><img src={`img/${tabela.g4}.png`} className="img" /> </tr>
